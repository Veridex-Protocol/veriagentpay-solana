...
export const PAYMENT_PRESETS: PaymentPreset[] = [
  {
    ...
    command: 'Send 20 USDT to @ella for dinner',
    amount: '20.00',
    asset: 'USDT',
    ...
    limit: '100 USDT per day',
    received: '20 USDT received',
    sentAt: '12:42',
    receivedAt: '12:42',
    reference: '0x71f2…09c2',
  },
  {
    id: 'freelance',
    chipLabel: '🎨 Design work ($250)',
    command: 'Pay 250 USDT to @alex for logo design',
    amount: '250.00',
    asset: 'USDT',
    ...
    limit: '500 USDT per day',
    received: '250 USDT received',
    sentAt: '14:15',
    receivedAt: '14:15',
    reference: '0x3a81…5ef1',
  },
  {
    id: 'coffee',
    chipLabel: '☕ Morning coffee ($5)',
    command: 'Send 5 USDT to @sara for latte',
    amount: '5.00',
    asset: 'USDT',
    ...
    limit: '50 USDT per day',
    received: '5 USDT received',
    sentAt: '09:30',
    receivedAt: '09:30',
    reference: '0x8e42…12b0',
  },
  {
    id: 'split',
    chipLabel: '🍕 Share rent ($600)',
    command: 'Split 1200 USDT rent with @tomas',
    amount: '600.00',
    asset: 'USDT',
    ...
    network: 'BOTChain',
    fee: '$0.00',
    authorization: 'Split rent',
    limit: '1000 USDT per day',
    received: '600 USDT received',
    sentAt: '18:04',
    receivedAt: '18:04',
    reference: '0x99c4…77d1',
  },
];
